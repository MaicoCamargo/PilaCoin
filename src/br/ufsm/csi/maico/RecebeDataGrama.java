    ...
    public void run() {
            ...
            while (true){
                try {
                    ...
                    Mensagem respostaServidor = (Mensagem) Utils.deserializarObjeto(receivePacket.getData());//desserealizo a msg recebida
                    System.out.println("MSG TIPO :" + respostaServidor.getTipo()+"<>"+respostaServidor.getIdOrigem());
                    if (respostaServidor.getTipo().equals(Mensagem.TipoMensagem.DISCOVER) && !respostaServidor.getIdOrigem().equals(meuId)) {
                        ...
                        System.out.println("IP:.: "+respostaServidor.getEndereco());
